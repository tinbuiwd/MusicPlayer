...
- (NSString *) getFilenameForAlbum:(AlbumData *)album trackNumber:(NSUInteger)trackNumber {
...
- (AVAudioPlayer *)createAudioPlayerWithAlbum:(AlbumData *)album trackNumber:(NSUInteger)trackNumber {
